...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      // Use a higher z-index so Dialog always appears above custom modals (many use z-50)
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal data-slot="dialog-portal">
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        // Force visible styling to avoid theme/z-index issues when nested inside other overlays
